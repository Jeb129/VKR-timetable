...
from .models.models import (
    Building, Classroom, Institute, StudyProgram, StudyGroup, 
    Teacher, Discipline, LessonType, Timeslot, Lesson, 
    AcademicLoad, BuildingPriority, Constraint, ScheduleScenario
)
