...
router.register(r'bableclassrooms', ClassroomBookingAbleViewSet, basename='classrooms')
router.register(r'lableclassrooms', ClassroomLessonAbleViewSet, basename='classrooms')
