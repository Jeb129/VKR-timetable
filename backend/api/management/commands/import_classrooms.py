...
# ИСПРАВЛЕННЫЙ ПУТЬ ИМПОРТА (согласно твоей новой структуре)
from api.models.buildings import Building, Classroom 
        ...
        with open(file_path, mode='r', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                building, _ = Building.objects.get_or_create(
                    name=b_name,
                    defaults={
                        'short_name': b_name[:5], # Берем первые 5 символов (ограничение модели)
                        'address': 'Уточняется',
