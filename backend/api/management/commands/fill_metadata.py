...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        constraints = [
            ...
            ("Занятия с малым количеством часов не должны стоять в середине дня", 100, "lessons_length_sort"),
            ("Приоритет заполнения первой половины дня", 80, "morning_preference"),
            ("Окно у преподавателя", 50, "teachers_gap"),
            ("Превышение недельной нагрузки преподавателя", 50, "teacher_overload"),
        ]
