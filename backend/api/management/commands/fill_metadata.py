...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        institutes = [
            ...
            ("Юридический институт имени А. Ю. Новикова", "ЮИН"),
        ...
        constraints = [
            ...
            ("Физическая невозможность перехода между корпусами", 500, "building_travel_impossible"),
            ...
            ("Ручной приоритет расположения занятий", 300, "lessons_ordering"),
            ...
            ("Занятия с малым количеством часов не должны стоять в середине дня", 100, "lesson_persistence_sort"),
            ("Приоритет заполнения первой половины дня", 80, "morning_preference"),
            ("Окно у преподавателя", 50, "teachers_gap"),
            ("Превышение недельной нагрузки преподавателя", 50, "teacher_weekly_overload"),
            ("Превышение недельной нагрузки группы", 50, "group_weekly_overload"),
        ]
